-- https://github.com/krisajenkins/telescope-docker.nvim/blob/main/lua/telescope_docker/init.lua
...
M.setup = function()
  vim.keymap.set('n', '<leader>ps', M.docker_ps, { desc = 'Docker [P][S]' })
  vim.keymap.set('n', '<leader>pv', M.docker_ps, { desc = 'Docker [P][V]olumes' })
  vim.keymap.set('n', '<leader>pi', M.docker_images, { desc = 'Docker [I]mages' })
end
